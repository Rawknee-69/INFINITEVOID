...
module.exports ={
    ...
    run : async(client,message,args,prefix) => {
        ...
        {
            return message.channel.send({embeds : [new MessageEmbed().setColor(`#2f3136`).setDescription(`${client.emoji.cross} Only Guild Owner is allowed to run this command. Ask your Guild owner to run it.`)]})
        }
