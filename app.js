...
const Commandtable = new ascii().setHeading("security","Commands","Status");
const EventsTable = new ascii().setHeading("security","Events","Status");
...
readdirSync(`./commands/`).forEach(d => {
    ...
    for(const f of c) {
        ...
        Commandtable.addRow("security",cmd.name,"✅");
    }
});
...
readdirSync("./events/").forEach(e => {
    ...
    let eve = e.split(".")[0];
    EventsTable.addRow("security",eve,"✅");
});
