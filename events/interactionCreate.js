        ...
        if(interaction.isButton())
        {
            ...
            if(interaction.customId == `secure`)
            {
                ...
                if(d == `secure`)
                {
                    ...
                    if(!qrole || !interaction.guild.roles.cache.get(qrole)){
                        ...
                        interaction.guild.roles.cache.get(r.id).setPosition(interaction.guild.members.me.roles.highest.rawPosition - 1);
                    ...
                    if(qrole && interaction.guild.roles.cache.get(qrole)) interaction.guild.roles.cache.get(qrole).setPosition(interaction.guild.members.me.roles.highest.rawPosition - 1);
            ...
            if(interaction.customId == `beast`)
            {
                if(interaction.member.id !== interaction.guild.ownerId && !client.config.owner.includes(interaction.member.id))
                {
                    ...
                    if(interaction.guild.members.me.roles.highest.rawPosition <= interaction.guild.roles.highest.rawPosition - 2)
                    {
